...
# Supported timeframes (default 15m)
DEFAULT_TIMEFRAME = os.getenv("DEFAULT_TIMEFRAME", "15m")
HIGHER_TIMEFRAME = os.getenv("HIGHER_TIMEFRAME", "1h")  # For macro trend confirmation

# ==========================================
# 3. RISK MANAGEMENT RULES (STRICT 1%)
# ==========================================
...
MAX_OPEN_TRADES = int(os.getenv("MAX_OPEN_TRADES", "20"))  # 1 position per coin max across all 20 whitelisted pairs
