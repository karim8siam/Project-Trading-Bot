...
# ==========================================
# 4. MACHINE LEARNING & GEMINI PARAMETERS (STANDARD +4% QUALITY GATES)
# ==========================================
# Tier 1: Core Majors: BTC, ETH, BNB, SOL, XRP, ADA, NEAR, TRX -> 56.0%+
...
# Tier 2: High-Risk Alts: AVAX, DOGE, LINK, DOT -> 58.0%+
...
# Tier 3: Sniper Tokens: SUI, APT, RENDER, TIA, INJ, ARB, OP, FET, SEI -> 60.0%+
